...
- Move or remove Diana burrow/rare-mob visual assists and Experiment Solver.
- Audit Auto Sprint and every remaining input, click, macro, movement, and
  see-through-block behavior in Lite. An option being off by default is not a
  release decision.
