...
When all release gates pass, upload only `RotClient-2.1.0+mc26.1.2.jar` to the Lite project. Rot Client+ has
...
3. Run separate Minecraft 26.1.2 smoke tests for Lite and Plus, including old
...
Launch Minecraft 26.1.2 with only Lite enabled and test startup, `/rot`, dashboard
