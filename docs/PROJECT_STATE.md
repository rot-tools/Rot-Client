...
| Playable JARs | `RotClient-2.1.0+mc26.1.2.jar` (`rotclient`) and `RotClientPlus-2.1.0+mc26.1.2.jar` (`rotclientplus`) |
| Java | 25 |
...
6. Select `RotClient-2.1.0+mc26.1.2.jar` and `RotClientPlus-2.1.0+mc26.1.2.jar` from `build/libs/`; never select the sources JAR.
