...
| Minecraft | 26.2 |
| Mod | 2.0.1+mc26.2 |
| Other Minecraft targets | `release/26.1.2` publishes a Lite `2.1.0+mc26.1.2` playtest; no Plus build exists for that target. `port/26.3` publishes Lite and Plus `2.0.1+mc26.3` playtests. The 26.3 editions passed automated build and startup smoke tests, but in-world gameplay validation is pending. See `README.md` for the version matrix. |
...
| Automated baseline | Current working tree: **2,417** shared tests plus **205** Plus tests; 0 failures or errors. Shared and Plus client compilation, `verifyLegitJar`, `verifyDungeonJarBoundary`, `check`, and `clean build` pass. SHA-256: Rot Client `0382071FD305BC331A40BDAC163528A8637876FBECB8BA6206300416B5FA26D0`; Rot Client+ `BFE8A4819001E87BF2ECC4EC780CFDD725F20F52B4381A017830EE04889BCC54`. Minecraft runtime validation remains pending. |
