...
| Automated baseline | Current working tree: **2,415** shared tests plus **205** Plus tests; 0 failures or errors. Shared and Plus client compilation, `verifyLegitJar`, `verifyDungeonJarBoundary`, `check`, and `clean build` pass. SHA-256: Rot Client `E5E288273158397D12377B10F84090783901FA255A70064F7109ED356B9A8D26`; Rot Client+ `B965B639D81B5F80BA5F2B198C50EDED5B2DFB3D85D00949A96B7B1A9A800594`. Minecraft runtime validation remains pending. |
