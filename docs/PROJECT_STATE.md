...
| Automated baseline | Current working tree: **2,182** shared tests plus **181** Plus tests; 0 failures or errors. Shared and Plus client compilation, `verifyLegitJar`, and `clean build` pass. SHA-256: Rot Client `A33D667174E2A18139AAD300C6DE95FA78FEA61279D3E74984C6F31FE9E6FAC7`; Rot Client+ `BBE51775375E661F6F4FD81D20B2C1EFC6D352B30152AA52C9388334BE378D52`. Minecraft runtime validation remains pending. |
...
| Latest edition split | Auto Clicker and Cheater Wardrobe typed config are Plus-owned. Wardrobe slot binds, delays, enable state, dashboard routing, and hidden-equip runtime now resolve through Plus while legacy profile values survive as opaque `extensionFields`. Lite's verifier rejects the moved identifiers. Superboom typed F7 settings and four shared dungeon parents remain in Lite audit scope. Minecraft runtime retest pending. |
