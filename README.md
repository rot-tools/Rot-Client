...
| **Dungeons** | HUD and map, visual ESP, terminals overlays, puzzles, F7 boxes/HUD, carry tracker, reward reels. F7 wrong-click blocking, Dungeon Breaker client block rewriting, Terminal Simulator, Terminal Click Trails, secret hitboxes, auto terms, and hover-terms are Rot Client+; remaining Lite dungeon assists are under release audit |
...
| **Fishing, foraging & garden** | Bite HUD, sea creatures, observed hotspot circles, trophy, tree HUD. Sea-creature auto attack, hotspot radar/tracer, Farm Keys, and foraging cheats are Rot Client+ |
