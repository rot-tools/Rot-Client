...
public final class QolUtilityCatalog {
    ...
    private static List<ModuleDef> buildModules() {
        ...
        modules.add(module(
                ...
                setting("qol.player_display.hide_elements", "Hide Elements", "Hide selected vanilla HUD elements.", SettingType.SECTION),
                setting("qol.player_display.hide_vanilla_health", "Hide Vanilla Health", "Local hide of vanilla health bar.", SettingType.TOGGLE),
                setting("qol.player_display.hide_vanilla_food", "Hide Vanilla Food", "Local hide of vanilla food bar.", SettingType.TOGGLE),
                setting("qol.player_display.hide_vanilla_armor", "Hide Vanilla Armor", "Local hide of vanilla armor bar.", SettingType.TOGGLE),
                setting("qol.player_display.hide_vanilla_xp", "Hide Vanilla XP", "Local hide of vanilla experience level.", SettingType.TOGGLE),
                setting("qol.player_display.hide_action_bar", "Hide Action Bar Elements", "Hide selected SkyBlock action-bar stats.", SettingType.SECTION, "action bar"),
                setting("qol.player_display.hide_action_health", "Hide Action Health", "Strip health fragment from action bar.", SettingType.TOGGLE),
                setting("qol.player_display.hide_action_defense", "Hide Action Defense", "Strip defense fragment from action bar.", SettingType.TOGGLE),
                setting("qol.player_display.hide_action_mana", "Hide Action Mana", "Strip mana fragment from action bar.", SettingType.TOGGLE),
                setting("qol.player_display.hide_action_overflow", "Hide Action Overflow", "Strip overflow fragment from action bar.", SettingType.TOGGLE),
                setting("qol.player_display.hide_action_speed", "Hide Action Speed", "Strip speed fragment from action bar.", SettingType.TOGGLE),
                setting("qol.player_display.hide_action_vitality", "Hide Action Vitality", "Strip vitality fragment from action bar.", SettingType.TOGGLE),
                setting("qol.player_display.hide_action_location", "Hide Action Location", "Strip the SkyBlock zone name Hypixel inserts into the action bar when you change areas.", SettingType.TOGGLE),
        ...
        modules.add(module(
                "qol.storage_overlay",
                "Storage Overlay",
                "Replace Storage menus with a compact overview of every server-observed Ender Chest and Backpack page. Navigation uses the real overview slot or /enderchest and /backpack.",
                Group.INTERFACE,
                "Inventory",
                false,
                true,
        ...
        modules.add(module(
                ...
                "Inventory Buttons",
                "Shortcut icons around inventories. Shift-left-drag an icon in-game to move it. Use Open Editor for command, icon, size, and anchors.",
                Group.INTERFACE,
                "Inventory",
                false,
                true,
        ...
        modules.add(module(
                ...
                "Inventory Overlay",
                "Four stacked bars between the player and crafting show necklace, cloak, belt, and gloves. Click any bar to open Stats & Equipment. The pet sits to the right of the bottom bar; Ctrl+left-click and drag to move it. The wrench at the top-right of inventory opens background colors.",
                Group.INTERFACE,
                "Inventory",
                false,
                true,
                true,
                List.of("equipment", "recipe book", "pet slot", "inventory", "potion", "effects", "color", "wrench"),
                setting("qol.inventory_overlay.equipment", "Equipment Slots", "Draw four stacked equipment bars. Empty bars show a + and any click opens Stats & Equipment. The vanilla off-hand slot is hidden.", SettingType.TOGGLE, "equipment"),
        ...
        modules.add(module(
                "qol.slot_binds",
                "Slot Binds",
                "Bind a hotbar slot to an inventory slot, draw a connector, and shift-click to swap.",
                Group.INTERFACE,
                "Inventory",
                false,
                true,
        ...
        modules.add(module(
                "qol.fullbright",
                "Fullbright",
                "Raise the client lightmap to full brightness so caves and dungeons are readable. Local render only; it does not change the server.",
                Group.RENDER,
                "Lighting",
                false,
                true,
        ...
        modules.add(module(
                "qol.dungeon_hud",
                "Dungeon HUD",
                "Secrets, score, class, invincibility timers and a scanned Magical Map.",
                Group.DUNGEONS,
                "HUD",
                false,
                true,
                ...
                setting("qol.dungeon_hud.invincibility", "Invincibility", "Bonzo, Spirit Mask and Phoenix timers.", SettingType.TOGGLE),
                ...
                setting("qol.dungeon_hud.map", "Dungeon Map", "Scan Magical Map rooms, doors, checkmarks and player icons.", SettingType.TOGGLE),
                setting("qol.dungeon_hud.map_doors", "Map Doors", "Draw wither, blood, fairy, entrance and opened-wither doors.", SettingType.TOGGLE),
                setting("qol.dungeon_hud.map_players", "Map Players", "Draw the local player chevron and teammate markers.", SettingType.TOGGLE),
                setting("qol.dungeon_hud.map_extra", "Extra Info Under Map", "Secrets, crypts, score and deaths under the map.", SettingType.TOGGLE),
                setting("qol.dungeon_hud.map_hide_boss", "Hide Map In Boss", "Hide the scanned map while the sidebar looks like a boss fight.", SettingType.TOGGLE),
                setting("qol.dungeon_hud.crypts", "Crypts", "Show crypt count under the map.", SettingType.TOGGLE),
                setting("qol.dungeon_hud.deaths", "Deaths", "Show death count under the map.", SettingType.TOGGLE),
                ...
                setting("qol.dungeon_hud.cheater_map", "Cheater Map", "Reveal hidden rooms behind wither/blood doors. Cheat, off by default.", SettingType.TOGGLE, "cheat"),
                setting("qol.dungeon_hud.cheater_names", "Hidden Names", "Label hidden and unvisited rooms.", SettingType.TOGGLE, "cheat"),
                setting("qol.dungeon_hud.cheater_darken", "Darken Hidden", "Darken hidden rooms and doors.", SettingType.TOGGLE, "cheat"),
        ...
        modules.add(module(
                ...
                setting("qol.dungeon_esp.secret_waypoints", "Secret Waypoints", "Box room-core chest/item/bat/essence locations from shipped dungeon data.", SettingType.TOGGLE),
                ...
                setting("qol.dungeon_esp.doors", "Door Highlight", "Local title when wither/blood keys spawn or doors open.", SettingType.TOGGLE),
        ...
        modules.add(module(
                ...
                "Dungeon Announce",
                "Party-chat Mimic / Prince / Bat kills and a Blood Camp ready title.",
                Group.DUNGEONS,
                "Alerts",
                false,
                true,
                true,
                List.of("mimic", "prince", "bat", "blood camp", "watcher"),
        ...
        modules.add(module(
                ...
                setting("qol.dungeon_terminals.numbers", "Numbers", "Overlay Click in order.", SettingType.TOGGLE),
                ...
                setting("qol.dungeon_terminals.colors", "Colors", "Overlay Select all the items.", SettingType.TOGGLE),
                setting("qol.dungeon_terminals.panes", "Red-Green", "Overlay Correct all the panes.", SettingType.TOGGLE),
                setting("qol.dungeon_terminals.starts", "Start-With", "Overlay What starts with.", SettingType.TOGGLE),
                ...
                setting("qol.dungeon_terminals.auto", "Auto Click", "Click solved terminal slots locally. Cheat.", SettingType.TOGGLE, "cheat"),
                setting("qol.dungeon_terminals.delay", "Click Delay", "Client ticks between auto clicks.", SettingType.NUMBER),
                ...
                setting("qol.dungeon_terminals.sounds", "Click Sounds", "Play a local note when Auto Terms clicks.", SettingType.TOGGLE),
                ...
                setting("qol.dungeon_terminals.melody_keys", "Melody Keys", "Press 1-4 to click Melody columns.", SettingType.TOGGLE),
        ...
        modules.add(module(
                "qol.dungeon_puzzles",
                "Dungeon Puzzles",
                "Oruo quiz answers, Three Weirdos truth chest, Blaze HP order, Ice Fill, Water Board, Boulder and TP Maze.",
                Group.DUNGEONS,
                "Puzzles",
                false,
                true,
                true,
                List.of("quiz", "oruo", "weirdos", "blaze", "trivia"),
                ...
                setting("qol.dungeon_puzzles.blaze", "Blaze Order", "Highlight the next blaze by HP.", SettingType.TOGGLE),
                setting("qol.dungeon_puzzles.ice", "Ice Fill", "Trace the remaining ice path.", SettingType.TOGGLE),
                setting("qol.dungeon_puzzles.water", "Water Board", "Highlight levers that flood every chest gate.", SettingType.TOGGLE),
                setting("qol.dungeon_puzzles.boulder", "Boulder", "Show the next boulder push toward the chest.", SettingType.TOGGLE),
                setting("qol.dungeon_puzzles.tp_maze", "TP Maze", "Follow observed teleport pads to the chest.", SettingType.TOGGLE)));
        ...
        modules.add(module(
                ...
                setting("qol.dungeon_f7.crystal_spawn", "Spawn Timer", "HUD ticks until Maxor crystals respawn.", SettingType.TOGGLE),
                ...
                setting("qol.dungeon_f7.simon", "Simon Says", "Box the Simon start and remaining sequence buttons.", SettingType.TOGGLE),
                ...
                setting("qol.dungeon_f7.auto_superboom", "Auto Superboom", "Swap to Superboom TNT and use it on cracked/crypt secret walls. Cheat, off by default.", SettingType.TOGGLE, "cheat"),
                ...
                setting("qol.dungeon_f7.superboom_delay", "Superboom Delay", "Client ticks between Superboom uses.", SettingType.NUMBER)));
        ...
        modules.add(module(
                "qol.slayer_progress",
                "Slayer Progress",
                "Show verified Slayer Combat XP from the action bar and warn once when it crosses the configured boss-spawn threshold.",
                Group.SLAYER,
                "HUD",
                false,
                true,
        ...
        modules.add(module(
                ...
                setting("qol.slayer_drops.detect_automatically", "Detect Automatically", "Follow the latest RNG Meter selection chat line for the active Slayer family.", SettingType.TOGGLE),
        ...
        modules.add(module(
                ...
                setting("qol.slayer_inferno.fire_pillar", "Pillar Display", "Title and HUD when a Fire Pillar is about to explode.", SettingType.TOGGLE),
        ...
        modules.add(module(
                "qol.ghosts",
                "Ghosts",
                "Dwarven Mines ghosts: invisible charged creepers. Show Ghosts reveals the body; Show Powered Layer keeps the vanilla charged overlay.",
                Group.RENDER,
                "Players",
                false,
                true,
                true,
                List.of("ghosts", "creeper", "dwarven mines", "powered"),
                setting("qol.ghosts.show_ghosts", "Show Ghosts", "Show the creeper entities.", SettingType.TOGGLE),
                setting("qol.ghosts.show_powered", "Show Powered Layer", "Show the powered layer for creepers.", SettingType.TOGGLE),
